      ...
      <main className="flex flex-col items-center justify-center p-4 mt-8">
          <div className="bg-gray-900 bg-opacity-80 rounded-xl shadow-lg backdrop-blur-sm p-8 w-full max-w-md">
            ...
            <p className="text-center mb-6">
              You've selected the <span className="font-semibold">{plan}</span> plan at{" "}
              <span className="font-semibold">{price}</span>
            </p>

            <Tab.Group onChange={(index) => setSelectedPaymentMethod(["card", "paypal", "applepay"][index])}>
              ...
              <Tab.Panels>
                ...
                <Tab.Panel>
                  <p className="text-center mb-4">Click the button below to pay with PayPal</p>
                  <button
