...
export default function AuthWrapper({ children, type }: any) {
  ...
  return (
    <main className="flex items-center justify-center p-4 h-[calc(100vh-80px)]">
      <div className="w-full max-w-md bg-gray-900 bg-opacity-80 rounded-xl shadow-lg backdrop-blur-sm p-8">
        {children}
        <div className="mt-6">
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full flex items-center justify-center py-2 px-4 border border-gray-600 rounded-md shadow-sm text-sm font-medium text-white bg-gray-800 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              <svg
