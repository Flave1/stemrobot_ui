          ...
          <div className="h-full w-full md:px-5 xl:px-20 pt-5 text-white">
            ...
            <div className="flex font-mono mt-8 md:mt-5 text-center md:text-left md:w-[100%] ">
              <div className="  text-gray-200 px-2 md:py-10 md:pt-20 md:w-[100%]">
                <h2 className="font-bold text-2xl lg:text-[40px] ">
                  Stembots AI Trader: Mastering the Markets with Intelligent
                  Precision
                </h2>
                <p className="py-5 md:py-8 lg:text-xl">
                  Stembots AI Trader merges cutting-edge artificial intelligence
                  with advanced human-like strategies, analyzing and adapting to
                  market conditions in real-time to make high-precision trades.
                  It manages risk, monitors capital, and ensures optimal trading
                  performance for every market condition.
                </p>
                <h3 className="text-xl font-bold pb-2">
                  Best for these industry
                </h3>
                <ul className="">
                ...
                <div className="mt-10 md:mt-10 flex justify-center mx-auto md:justify-normal">
                  ...
                  <button className=" flex bg-[#2e2d2d] px-1 rounded-lg">
                    <div className="mr-2 w-[45%] flex">
                      ...
                      <a href="/" className="font-bold text-1xl mt-1"> {' <=Back'}</a>
            ...
            <div className=" p-20">
              <div className=" text-center  mx-auto">
                <div className="flex text-center mx-auto justify-center">
                  ...
                  <h1 className=" px-4  font-thin text-2xl">
                    STEMBOTS
                  </h1>
                  <h1 className="text-red-500 font-thin text-2xl">Works</h1>
                </div>
                <p className="text-white">
                  With proprietary AI algorithms, Stembots continuously learns
                  from market data, predicting trends and automating trades. It
                  is built for adaptability, efficiently executing trades,
                  managing risks, and making calculated decisions under any
                  market condition.
                </p>
              </div>
            </div>
