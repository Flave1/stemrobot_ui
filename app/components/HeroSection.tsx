const HeroSection = () => (
  <section className="bg-gray-800 text-white h-screen flex flex-col justify-center items-center">
    ...
    <p className="text-lg mb-8 text-center px-20">A reliable trading robots for the forex market. Designed to execute trades efficiently and adapt to market conditions, our robots help traders automate their strategies, maximize returns, and reduce risk.</p>
