...
<div className=" flex  lg:w-[20%] ">
  <Link href="/">
    <img src="/logo.png" alt="" className="h-[40px] md:h-[50px] rounded-lg border-4 border-red-700" />
  </Link>
</div>
...
<ul className=" md:flex md:text-center md:justify-center lg:text-right lg:float-right">
    <li className="px-4 pt-2 "><Link href="/products" className="hover:text-white">Products</Link></li>
    <li className="px-4 pt-2 "><Link href="/about" className="hover:text-white">About</Link></li>
    <li className="px-4 pt-2 "><Link href="/robots" className="hover:text-white">Trade Robots</Link></li>
    <li className="px-4 py-2 "><Link href="/contact" className="hover:text-white">Contact</Link></li>
  </ul>
</div>
